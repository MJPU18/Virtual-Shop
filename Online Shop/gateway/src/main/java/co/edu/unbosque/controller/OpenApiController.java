...
public class OpenApiController {
    ...
    public Mono<String> getClientServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://client-service:8085/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
    ...
    public Mono<String> getProductServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://product-service:8084/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<String> getUserServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://user-service:8086/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<String> getSaleDetailServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://saledetail-service:8081/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<String> getSaleServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://sale-service:8082/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
                .bodyToMono(String.class)
    ...
    public Mono<String> getProviderServiceOpenApi(ServerHttpRequest request) {
        return webClient.get()
                .uri("http://provider-service:8083/v3/api-docs") // Usar nombre de servicio Docker
                .retrieve()
                .bodyToMono(String.class)
